...
export default function Navbar() {
  ...
  return (
    <motion.nav
      ...
      className="hidden lg:block fixed top-0 left-0 right-0 z-50 bg-white/80 dark:bg-gray-900/80 backdrop-blur-lg border-b border-white/20 dark:border-gray-700/50"
    >
